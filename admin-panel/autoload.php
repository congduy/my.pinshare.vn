    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'manage-users' || $page == 'manage-stories' || $page == 'manage-profile-fields' || $page == 'add-new-profile-field' || $page == 'edit-profile-field' || $page == 'manage-verification-reqeusts' || $page == 'affiliates-settings' || $page == 'payment-reqeuests' || $page == 'referrals-list' || $page == 'online-users' || $page == 'manage-genders') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
							...
							<li <?php echo ($page == 'manage-users-balances') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo Wo_LoadAdminLinkSettings('manage-users-balances'); ?>">Manage Users with Balances</a>
                            </li>
			   ...
			   <!--   Chuc nang Bank Share  -->
					<li <?php echo ($page == 'rentpin-01') ? 'class="active"' : ''; ?>>
                        <a href="<?php echo Wo_LoadAdminLinkSettings('rentpin-01'); ?>">
                            <i class="material-icons">update</i>
                            <span>Rent: RL3H081911250068</span>
                        </a>
                    </li>
					
					<li <?php echo ($page == 'rentpin-02') ? 'class="active"' : ''; ?>>
                        <a href="<?php echo Wo_LoadAdminLinkSettings('rentpin-02'); ?>">
                            <i class="material-icons">update</i>
                            <span>Rent: RL3H081911640069</span>
                        </a>
                    </li>
