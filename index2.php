<html><head>
  ...
  <title>workerman-chat PHP Websocket(HTLM5/Flash)+PHP socket </title>
  ...
  <script type="text/javascript">
    ...
    function connect() {
       // 创建websocket
       //ws = new WebSocket("ws://192.168.4.20:7272");
 ws = new WebSocket("ws://"+document.domain+":7272");
       ...
       ws.onclose = function() {
    	  console.log("The connection is closed and the reconnection is scheduled");
          connect();
       };
       ws.onerror = function() {
    ...
    function onopen()
    {
        ...
        console.log("websocket Successful handshake, send login data:"+login_data);
        ws.send(login_data);
    }
    ...
    function flush_client_list(){
    	...
    	userlist_window.append('<h4>online user</h4><ul>');
    ...
    <div class="container">
	    <div class="row clearfix">
	        ...
	        <div class="col-md-6 column">
               ...
               <p class="cp">PHP +Websocket(HTML5/Flash)+PHP Socket &nbsp;&nbsp;&nbsp;&nbsp;Powered by <a href="http://www.workerman.net/workerman-chat" target="_blank">workerman-chat</a></p>
	        </div>
	        <div class="col-md-3 column">
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=1">room1</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=2">room2</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=3">room3</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/?room_id=4">room4</a>
               <br><br>
               </div>
               <p class="cp">PHP +Websocket(HTML5/Flash)+PHP Socket &nbsp;&nbsp;&nbsp;&nbsp;Powered by <a href="http://www.workerman.net/workerman-chat" target="_blank">workerman-chat</a></p>
	        </div>
